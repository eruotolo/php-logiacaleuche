...
<head>
    ...
    <title><?php echo $titulo ?> | Registro Entrada Dinero</title>
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Entrada de Caja</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            ...
                            if ($_SESSION['category'] == 2 || $_SESSION['username'] == '270396356'){
                                ...
                                ?>
                                <div>
                                    <a href="#" class="btn btn-light disabled"><i class="bx bx-plus me-1"></i> Nuevo Documento</a>
                                </div>
                                <?php
                            }
                            ?>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Registro Entrada de Dinero</h4>
                            </div><!-- end card header -->
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_Array($result_task))  {
                                            ?>
                                            <tr>
                                                <td style="display:none;"><?php echo $row['id_Entrada'] ?></td>
                                                ...
                                                <td data-order="<?php echo strtotime($row['entrada_MovimientoFecha']); ?>"><?php echo date('d-m-Y H:i', strtotime($row['entrada_MovimientoFecha'])); ?></td>
                                                <td>$ <?php echo number_format($row['entrada_Monto'], 0, ',', '.'); ?></td>
                                                <td style="text-align: center">
                                                    <a href="apps-tesoreria-entrada-editar.php?id_Entrada=<?php echo $row['id_Entrada'] ?>" class="text-success me-2" title="Editar">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="controller/enviar-boleta.php?id_Entrada=<?php echo $row['id_Entrada'] ?>" class="text-primary" title="Enviar Boleta">
