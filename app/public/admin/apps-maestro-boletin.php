...
<head>
    ...
    <title><?php echo $titulo ?> | Boletines</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Lista de Boletines de los QQ:. Maestros</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Boletines</a></li>
                                    <li class="breadcrumb-item active">Listado de boletines</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            ...
                            if ($_SESSION['category'] == 2 || $_SESSION['username'] == '270396356'){
                                ?>
                                <div>
                                    <a href="apps-boletin-new.php" class="btn btn-light"><i class="bx bx-plus me-1"></i> Nuevo Boletín</a>
                                </div>
                                <?php
                            } else{
                                ?>
                                <div>
                                    <a href="apps-boletin-new.php" class="btn btn-light disabled" =""><i class="bx bx-plus me-1"></i> Nuevo Boletín</a>
                                </div>
                                <?php
                            }
                            ?>
                ...
                <div class="table-responsive mb-4">
                    <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                        ...
                        <tr>
                            ...
                            <th scope="col">Nombre Boletín</th>
                        ...
                        $query ="SELECT * FROM boletin B
                            JOIN grado G
                            on B.grado_Boletin = G.id WHERE grado_Boletin = 3";
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['titulo_Boletin'] ?></td>
