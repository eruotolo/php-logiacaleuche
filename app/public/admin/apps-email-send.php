                    ...
                    <div class="col-12">
                        ...
                        <div class="email-leftbar card">
                            ...
                            <div class="mail-list mt-4">
                                ...
                                <a href="apps-email-send.php" class="active"><i class="mdi mdi-email-check-outline me-2"> </i>Enviados</a>
                                    ...
                                    while ($row = mysqli_fetch_Array($result_task))
                                    {
                                        ...
                                        <li>
                                            <div class="col-mail col-mail-1">
                                                ...
                                                <a href="apps-email-view.php?id_Message=<?php echo $row['id_Message'] ?>" class="title"><?php echo $row['utname'] ?> <?php echo $row['utlastname'] ?></a>
