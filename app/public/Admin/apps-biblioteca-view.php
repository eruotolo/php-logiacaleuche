...
//$usuario = $row;
        ...
        <head>
            ...
            <title><?php echo $titulo ?> | Ver Acta</title>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="card-title-desc">
                                            <?php echo $row['nombre_Libro'] ?> <code>|</code>
                                            <?php echo $row['grado_nombre'] ?></p>
                                    </div>
                                    <div class="card-body p-4">
                                        <embed src="uploads/biblioteca/<?php echo $row['file_name'] ?>" type="application/pdf" width="100%" height="600px" />
                                    </div>
                                </div>
                            </div>
                        </div>
